...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([0, 0, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 99, 0])
    expected2 = ([1, 2, 3, 9], [77, 4, 5, 1, 5, 6], [4, 4, 4], [4, 99, 7])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 4, 0, 9], [0, 12, 0, 1, 5, 0], [4, 0, 4], [9, 75, 68])
    expected3 = ([1, 4, 2, 9], [3, 12, 4, 1, 5, 5], [4, 6, 4], [9, 75, 68])
    zero_changer(test3)
    print()
    print('Test 3:')
    ...
    for k in range(len(tuple_of_lists)):
        for j in range(len(tuple_of_lists[k])):
            if tuple_of_lists[k][j] == 0:
                tuple_of_lists[k][j] = zero_addition
                zero_addition = zero_addition + 1
